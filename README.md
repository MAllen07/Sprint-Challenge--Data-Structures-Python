...
1. Implement a data structure called a ring buffer (more details below) (ring buffer)
2. Optimizing some inefficient code  (names)
3. Reversing the contents of a singly linked list (reverse)
